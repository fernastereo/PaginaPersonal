<template>
  <section class="text-white mt-20" id="contact">
    ...
    <div class="grid md:grid-cols-2 gap-4 relative px-4 xl:px-16 mt-8" data-aos="zoom-in-up">
      <div>
        <p class="text-[#adb7be]">Lorem ipsum dolor sit amet consectetur adipisicing elit. Corporis, officiis pariatur, 
            velit maxime placeat iste facilis molestiae quisquam corrupti, 
            fugiat vero necessitatibus rerum quasi perspiciatis? Repudiandae ex quis culpa minus?
        </p>
      ...
      <div style="background: #111a3e; width: 100%; height: 100%; border-radius: 20px; overflow: hidden; border: 1px solid #111a3e; backdrop-filter: blur(9px); -webkit-backdrop-filter: blur(9px);">
        <form class="flex flex-col p-2" data-aos="zoom-in-up">
          <div class="mb-6">
            ...
            <input type="email" id="email" class="bg-[#111827] placeholder:[#9ca2a9] text-gray-100 text-sm rounded-lg block w-full p-2.5" placeholder="email" name="email"/>
          </div>
          <div class="mb-6">
          ...
          <div class="mb-6">
            ...
            <textarea id="message" class="bg-[#111827] placeholder:[#9CA2A9] text-gray-100 text-sm rounded-lg block w-full p-2.5" placeholder="Let's talk about ..." name="message"></textarea>
          </div>
          <button class="z-1 w-[100%important] px-6 md:px-7 py-3 rounded-full sm:w-max flex justify-center text-white bg-primary border-2 border-transparent">Send Message</button>
        </form>
      </div>
